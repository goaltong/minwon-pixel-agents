 ...
 * - Added active provider plumbing so standalone WebSocket clients receive
 *   capability metadata for the provider selected at server startup.
 */
...
export interface HttpServerOptions {
  ...
  /** Active hook provider used by the runtime. */
