 ...
 * - Added active HookProvider to the WebSocket client-message context.
 * - Changed providerCapabilities to report the selected provider instead of
 *   always reporting Claude capabilities.
 */
